...
public :
    ...
    int hauteur(noeud* x) ; //  retourne la hauteur de l'arbre enraciné par x
    ...
    void desequilibre(noeud* x) ; // met à jour l'attribut d de chaque noeud de l'arbre enraciné par x
